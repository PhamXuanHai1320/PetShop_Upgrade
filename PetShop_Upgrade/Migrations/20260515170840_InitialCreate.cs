    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    Favor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodsDetails", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK_FoodsDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetVariant", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK_PetVariant_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductHistories_AspNetUsers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_AspNetUsers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToysDetails", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK_ToysDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiscountUsages_AspNetUsers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PainAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    OrderCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetHealthRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PetHealthRecords_PetVariant_ProductId",
                        column: x => x.ProductId,
                        principalTable: "PetVariant",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PetVaccination_PetVariant_ProductId",
                        column: x => x.ProductId,
                        principalTable: "PetVariant",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryLocks_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryLocks_ProductColors_ProductColorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountUsages_MemberId",
                table: "DiscountUsages",
                column: "MemberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryLocks_OrderId",
                table: "InventoryLocks",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryLocks_ProductColorId",
                table: "InventoryLocks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetHealthRecords_ProductId",
                table: "PetHealthRecords",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_PetVaccination_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductHistories_MemberId",
